...
# 3. Tushare日线 7/20-8/20
print("\n=== Tushare daily 7/20-8/20 ===")
daily = pro.daily(ts_code=ts_code, start_date='20260720', end_date='20260824')
daily = daily.sort_values('trade_date').reset_index(drop=True)
print(daily.to_string(index=False))

# 4. 资金流
print("\n=== Tushare moneyflow 8月 ===")
mf = pro.moneyflow(ts_code=ts_code, start_date='20260801', end_date='20260824')
mf = mf.sort_values('trade_date').reset_index(drop=True)
print(mf.to_string(index=False))

# 5. 基本面
print("\n=== Tushare daily_basic 8月 ===")
db = pro.daily_basic(ts_code=ts_code, start_date='20260801', end_date='20260824')
